...
def start_message(message):
    bot.send_message(message.chat.id, f"Приветствую, *{message.from_user.first_name}!*\nДобро пожаловать в телефонный справочник телеграмма: \nЗдесь вы можете хранить всю информацию по вашим \nконтактам и не боятся потерять эти данные (в случае потери телефона, смены сим-карты и прочих ситуаций) \nДля пониманий возможностей данной библиотеки контактов, воспользуйтесь командой /help")
